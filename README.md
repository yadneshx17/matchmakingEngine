...
## 🧑‍💻 Tech Stack
- FastAPI (Core API and server logic)
- Redis (Real-time queueing, Pub/Sub, and caching)  
- Socket.IO (real-time client/server notifications and backend communication)  
- Python asyncio (Real-time communication between clients and backend)  
